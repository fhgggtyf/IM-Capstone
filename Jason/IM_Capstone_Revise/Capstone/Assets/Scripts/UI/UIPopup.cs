...
public class UIPopup : MonoBehaviour
{
    ...
    public void SetPopup(PopupType popupType)
    {
        ...
        _titleText.StringReference.TableEntryReference = _actualType.ToString() + "PopupTitle";
        _descriptionText.StringReference.TableEntryReference = _actualType.ToString() + "PopupDescription";
        string tableEntryReferenceConfirm = PopupButtonType.Confirm + "" + _actualType;
        string tableEntryReferenceCancel = PopupButtonType.Cancel + "" + _actualType;
        switch (_actualType)
        {
